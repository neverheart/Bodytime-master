...
@synthesize ValueBaseMetabolism;
...
- (IBAction)raschet:(id)sender {
    ...
    ValueBaseMetabolism=[self valueBaseMetabolismWithAge:[NSNumber numberWithFloat:[myAgeTextField.text floatValue]]
